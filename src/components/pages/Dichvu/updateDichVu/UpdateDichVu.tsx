...
const UpdateDichVu = (props:dichVuProps) => {
    ...
    <div className='layout_AddThietbi_Header row' >
        <div className='layout_AddThietbi_Header_Text col-8'>
            <div>
                ...
                <strong style={{ color: '#7E7D88' }}>{props.name.danhSach} </strong>
                <AiOutlineRight style={{ color: '#7E7D88', fontSize: '14px', width: '25px' }} />
                <Link to='/dichvu/detaildichvu' style={{ textDecoration: 'none' }} ><strong style={{ color: '#7E7D88' }}>{props.name.chiTiet} </strong></Link>
                <AiOutlineRight style={{ color: '#7E7D88', fontSize: '14px', width: '25px' }} />
